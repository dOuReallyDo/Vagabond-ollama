...
17. **🔮 Proposto: Nominatim geocoding per TravelMap** — Non ancora implementato. Usare Nominatim per convertire i nomi di località (da `mapPoints`) in coordinate lat/lng precise, migliorando l'accuratezza dei marker nella mappa di Step 1.
